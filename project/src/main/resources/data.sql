...
INSERT INTO article(id, title, content) VALUES (2, '가가가나', '2222');
INSERT INTO article(id, title, content) VALUES (3, '가가가다', '3333');

--article 더미 데이터
INSERT INTO article(id, title, content) VALUES (4, '당신의 인생 영화는?', '댓글');
INSERT INTO article(id, title, content) VALUES (5, '당신의 소울 프드는?', '댓글ㄱ');
